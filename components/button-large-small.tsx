...
const ButtonLargeSmall: NextPage<ButtonLargeSmallType> = ({
  ...
  return (
    <div className="rounded-3xs box-border w-[308px] h-[118px] flex flex-col items-center justify-center text-center text-21xl text-black font-header-footer-button-extra-small border-[2px] border-solid border-black">
