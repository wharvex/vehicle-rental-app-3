...
const FooterPage: NextPage<FooterPageType> = ({
  ...
  return (
    <footer
      className="overflow-hidden flex flex-row items-center justify-between py-5 px-[100px] box-border bg-[url('/footer--page@3x.png')] bg-cover bg-no-repeat bg-[top] text-center text-13xl text-black font-header-footer-button-extra-small self-stretch"
